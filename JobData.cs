    ...
    class JobData
    {
        ...
        public static List<Dictionary<string, string>> FindByColumnAndValue(string column, string value)
        {
            ...
            foreach (Dictionary<string, string> row in AllJobs)
            {
                ...
                //implemented case sensitivity in FINDBYCOLUMNANDVALUE to 
                //reduce chance of case insensitivity
                if (aValue.IndexOf(value, System.StringComparison.OrdinalIgnoreCase) >= 0)
                {
                    jobs.Add(row);
                }
                //commented out due to repeated lines of 
                //else
                //{
                //    Console.WriteLine("oops not a valid response, please try again.");
                //}
            }
